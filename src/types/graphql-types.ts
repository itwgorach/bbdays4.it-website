...
type Query_strapiVideospageArgs = {
  ...
  localizations: Maybe<STRAPI_VIDEOSPAGELocalizationsFilterInput>;
  strapi_id: Maybe<IntQueryOperatorInput>;
};
...
type STRAPI_VIDEOSPAGELocalizationsFilterInput = {
  readonly data: Maybe<STRAPI_VIDEOSPAGELocalizationsDataFilterListInput>;
};

type STRAPI_VIDEOSPAGELocalizationsDataFilterListInput = {
  readonly elemMatch: Maybe<STRAPI_VIDEOSPAGELocalizationsDataFilterInput>;
};

type STRAPI_VIDEOSPAGELocalizationsDataFilterInput = {
  readonly id: Maybe<IntQueryOperatorInput>;
  readonly attributes: Maybe<STRAPI_VIDEOSPAGELocalizationsDataAttributesFilterInput>;
};
...
type STRAPI_VIDEOSPAGELocalizationsDataAttributesFilterInput = {
  ...
  readonly updatedAt: Maybe<DateQueryOperatorInput>;
  readonly locale: Maybe<StringQueryOperatorInput>;
  readonly videospage: Maybe<STRAPI_VIDEOSPAGELocalizationsDataAttributesVideospageFilterListInput>;
  readonly localizations: Maybe<STRAPI_VIDEOSPAGELocalizationsDataAttributesLocalizationsFilterInput>;
};

type STRAPI_VIDEOSPAGELocalizationsDataAttributesVideospageFilterListInput = {
  readonly elemMatch: Maybe<STRAPI_VIDEOSPAGELocalizationsDataAttributesVideospageFilterInput>;
};
...
type STRAPI_VIDEOSPAGELocalizationsDataAttributesLocalizationsFilterInput = {
  readonly data: Maybe<STRAPI_VIDEOSPAGELocalizationsDataAttributesLocalizationsDataFilterListInput>;
};

type STRAPI_VIDEOSPAGELocalizationsDataAttributesLocalizationsDataFilterListInput = {
  readonly elemMatch: Maybe<STRAPI_VIDEOSPAGELocalizationsDataAttributesLocalizationsDataFilterInput>;
};

type STRAPI_VIDEOSPAGELocalizationsDataAttributesLocalizationsDataFilterInput = {
  readonly id: Maybe<IntQueryOperatorInput>;
  readonly attributes: Maybe<STRAPI_VIDEOSPAGELocalizationsDataAttributesLocalizationsDataAttributesFilterInput>;
};
...
type STRAPI_VIDEOSPAGEFilterInput = {
  ...
  readonly updatedAt: Maybe<DateQueryOperatorInput>;
  readonly locale: Maybe<StringQueryOperatorInput>;
  readonly localizations: Maybe<STRAPI_VIDEOSPAGELocalizationsFilterInput>;
  readonly strapi_id: Maybe<IntQueryOperatorInput>;
};
...
type pageCMateuszSelleobbdays4ItWebsitesrcpagesindexTsx3578812253QueryVariables = Exact<{ [key: string]: never; }>;


type pageCMateuszSelleobbdays4ItWebsitesrcpagesindexTsx3578812253Query = { readonly strapiHomepage: Maybe<{ readonly homepage: Maybe<ReadonlyArray<Maybe<(
      ...
      & { readonly lectures: Maybe<ReadonlyArray<Maybe<(
        ...
        & { readonly logo: Maybe<Pick<STRAPI_LECTURELogo, 'url' | 'alternativeText'>>, readonly localizations: Maybe<{ readonly data: Maybe<ReadonlyArray<Maybe<{ readonly attributes: Maybe<Pick<STRAPI_LECTURELocalizationsDataAttributes, 'title' | 'subtitle' | 'startHour' | 'room'>> }>>> }> }
      )>>>, readonly speakers: Maybe<ReadonlyArray<Maybe<(
        Pick<STRAPI_SPEAKER, 'firstName' | 'lastName' | 'title' | 'description' | 'position' | 'linkedinUrl' | 'twitterUrl' | 'linktrUrl' | 'backgroundColor' | 'bio'>
        & { readonly photo: Maybe<Pick<STRAPI_SPEAKERPhoto, 'url' | 'alternativeText'>>, readonly localizations: Maybe<{ readonly data: Maybe<ReadonlyArray<Maybe<{ readonly attributes: Maybe<Pick<STRAPI_SPEAKERLocalizationsDataAttributes, 'bio' | 'description' | 'firstName' | 'lastName' | 'position' | 'title'>> }>>> }> }
      )>>> }
    ) | (
      ...
      & { readonly backgroundImages: Maybe<ReadonlyArray<Maybe<Pick<STRAPI__MEDIA, 'id' | 'url' | 'alternativeText'>>>>, readonly achievements: Maybe<ReadonlyArray<Maybe<(
        ...
        & { readonly localizations: Maybe<{ readonly data: Maybe<ReadonlyArray<Maybe<{ readonly attributes: Maybe<Pick<STRAPI_ACHIEVEMENTLocalizationsDataAttributes, 'name' | 'number'>> }>>> }> }
      )>>> }
    ) | (
      ...
      & { readonly events: Maybe<ReadonlyArray<Maybe<(
        ...
        & { readonly logo: Maybe<Pick<STRAPI_EVENTLogo, 'url'>>, readonly localizations: Maybe<{ readonly data: Maybe<ReadonlyArray<Maybe<{ readonly attributes: Maybe<Pick<STRAPI_EVENTLocalizationsDataAttributes, 'title' | 'startHour' | 'endHour' | 'displayTitleOnDesktop' | 'date'>> }>>> }> }
      )>>> }
    ) | (
      ...
      & { readonly signupImage: Maybe<Pick<STRAPI__MEDIA, 'url'>>, readonly bannerImage: Maybe<Pick<STRAPI__MEDIA, 'url'>>, readonly signup_sections: Maybe<ReadonlyArray<Maybe<(
        ...
        & { readonly localizations: Maybe<{ readonly data: Maybe<ReadonlyArray<Maybe<{ readonly attributes: Maybe<Pick<STRAPI_SIGNUP_SECTIONLocalizationsDataAttributes, 'buttonText' | 'buttonUrl' | 'link' | 'subtitle' | 'title'>> }>>> }> }
      )>>> }
    ) | (
      ...
      & { readonly speakers: Maybe<ReadonlyArray<Maybe<(
        ...
        & { readonly photo: Maybe<Pick<STRAPI_SPEAKERPhoto, 'url'>>, readonly localizations: Maybe<{ readonly data: Maybe<ReadonlyArray<Maybe<{ readonly attributes: Maybe<Pick<STRAPI_SPEAKERLocalizationsDataAttributes, 'twitterUrl' | 'title' | 'position' | 'linktrUrl' | 'linkedinUrl' | 'lastName' | 'firstName' | 'description' | 'bio' | 'backgroundColor'>> }>>> }> }
      )>>> }
...
type pageCMateuszSelleobbdays4ItWebsitesrcpagesnagraniaTsx1886524413Query = { readonly strapiVideospage: Maybe<(
    ...
    )>>>, readonly localizations: Maybe<{ readonly data: Maybe<ReadonlyArray<Maybe<{ readonly attributes: Maybe<(
          Pick<STRAPI_VIDEOSPAGELocalizationsDataAttributes, 'subtitle' | 'footerSubtitle' | 'locale'>
          & { readonly videospage: Maybe<ReadonlyArray<Maybe<Pick<STRAPI_VIDEOSPAGELocalizationsDataAttributesVideospage, 'title' | 'isSectionVisible' | 'footer' | 'buttonUrl' | 'buttonText' | '_xcomponent'>>>> }
        )> }>>> }> }
  )> };
...
type staticCMateuszSelleobbdays4ItWebsitesrccomponentsLayoutPrivacyPolicyTsx602048249Query = { readonly strapiPrivacypolicy: Maybe<(
    ...
    & { readonly text: Maybe<{ readonly data: Maybe<Pick<STRAPI_PRIVACYPOLICY_TEXT_TEXTNODE, 'text' | 'id'>> }>, readonly localizations: Maybe<{ readonly data: Maybe<ReadonlyArray<Maybe<(
        ...
        & { readonly attributes: Maybe<Pick<STRAPI_PRIVACYPOLICYLocalizationsDataAttributes, 'locale' | 'text'>> }
      )>>> }> }
  )> };
