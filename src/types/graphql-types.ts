...
type STRAPI_VIDEOLISTThumbnailFormatsLargeFilterInput = {
  ...
  readonly width: Maybe<IntQueryOperatorInput>;
  readonly height: Maybe<IntQueryOperatorInput>;
  readonly sizeInBytes: Maybe<IntQueryOperatorInput>;
};
...
type STRAPI_VIDEOLISTFieldsEnum =
  ...
  | 'thumbnail.formats.large.sizeInBytes'
  ...
  | 'thumbnail.formats.small.sizeInBytes'
  ...
  | 'thumbnail.formats.medium.sizeInBytes'
  ...
  | 'thumbnail.formats.thumbnail.sizeInBytes'
  | 'thumbnail.hash'
  | 'thumbnail.ext'
  | 'thumbnail.mime'
  | 'thumbnail.size'
