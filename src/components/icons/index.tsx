...
export { default as ArrowButtonIconLong } from './arrow-button-icon-long.svg'
export { default as ArrowButtonIconShort } from './arrow-button-icon-short.svg'
...
export { default as PlayButtonIcon } from './play-button-icon.svg'
export { default as ArrowDownIcon } from './arrow-down-icon.svg'
export { default as BBDaysNewLogoWhite } from './bbdays-new-logo-white.svg'
